  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-30">
        <div className="max-w-6xl py-2 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-12">
            {/* Logo (taille réduite) */}
            <div className="flex items-center bg-white px-4 opacity-90 rounded-sm" style={{ }}>
              <Logo className="w-24 py-0" />
            </div>
